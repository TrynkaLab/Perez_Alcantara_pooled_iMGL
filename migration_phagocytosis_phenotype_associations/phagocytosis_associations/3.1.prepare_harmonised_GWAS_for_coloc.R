...
outDir = "../../../data/results/phagocytosis/3.coloc/subsets_for_coloc/"
dir.create(outDir, recursive = TRUE)

  # for testing
# external_GWAS_folder = as.character("/lustre/scratch123/hgi/teams/trynka/resources/summary_statistics/public/GCST90027164/")
