...
skat_results_path = "../../../data/results/phagocytosis/5.1.check_SKAT_WES_vs_phagocytosis/deleterious_SKATO_scaled_centered_prop_pvals.csv"
directory = "../../../data/results/phagocytosis/5.2.rare_vars_vs_phagocytosis/"
...
length(unique(line_prop_changes$line)) # 202
...
proliferation_w_info = proliferation_w_info %>%
  ...
  # filter to significant results in SKAt
...
for(mut_type in mut_types){
  ...
  length(unique(sub_table$gene)) ## 344 for del untreated
