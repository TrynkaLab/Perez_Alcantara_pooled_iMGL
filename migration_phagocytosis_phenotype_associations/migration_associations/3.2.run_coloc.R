...
######
outDir = "../../../data/results/migration/2.check_association_results/lm_1pct_filtered_deflated/coloc_results/"
dir.create(outDir)


# test data
external_data_folder = as.character("../../../data/results/migration/2.check_association_results/lm_1pct_filtered_deflated/subsets_for_coloc/GCST90012877/")
  ...
  for(locus in names(external_data[[comp]])){
    coloc_res[[comp]][[locus]] = list()
      ...
      if(nrow( external_data[[comp]][[locus]]) == nrow(GWAS[[comp]][[locus]])){
        ...
        # my migration GWAS wouldn't be, for example
