...
dir.create(file.path("../../data/results/1.5.compare_with_external_datasets"))
...
geneName_to_ensembl <- function(expr_df) {
  ...
  # collapse duplicate Ensembl IDs (important!)
  expr_df <- rowsum(as.matrix(expr_df), group = rownames(expr_df))
  
  return(as.data.frame(expr_df))
}
...
#Gazestani = readRDS("../../../resources/Gazestani_2023_early_late_AD/processed_by_Dolan/Fin.MG_Vahid_Final_seurat_2024.rds")
# this one is not annotated
Gazestani = readRDS("../../../resources/Gazestani_2023_early_late_AD/processed_by_Dolan/FinMg_Cellbender_annot_revision.rds")
