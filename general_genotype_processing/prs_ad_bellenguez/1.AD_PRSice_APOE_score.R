# Incorporating non-APOE PRSice score to APOE part
...
hipsci_IPMAR_prsice = read_delim("../../data/prs_ad_bellenguez/PRSice/PRSice_noAPOE_LD_from_1000G.all_score",delim = " ") %>%
  dplyr::select(FID,IID,`Pt_0.1`) %>%
  dplyr::rename(polygenic_score = `Pt_0.1`, line = IID) %>%
...
thousand_prsice = read_delim("../../data/prs_ad_bellenguez/PRSice/1000G_PRSice_noAPOE.all_score",delim = " ") %>%
  dplyr::select(FID,IID,`Pt_0.1`) %>%
  dplyr::rename(polygenic_score = `Pt_0.1`, line = IID) %>%
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_1000g_raw_polygenic_score_AD_Bellenguez_noAPOE.pdf",
    width = 7, height = 5)
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_1000g_scaled_polygenic_score_AD_Bellenguez_noAPOE.pdf",
    width = 7, height = 5)
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_1000g_raw_APOE_score.pdf",
    width = 7, height = 5)
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_1000g_scaled_APOE_score.pdf",
    width = 7, height = 5)
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_full_polygenic_score_AD_Bellenguez_withAPOE.pdf",
    width = 7, height = 5)
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_full_polygenic_score_AD_Bellenguez_withAPOE_changing_ranks.pdf",
    width = 7, height = 5)
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_full_polygenic_score_AD_Bellenguez_withAPOE_changing_ranks_our_data_only.pdf",
    width = 7, height = 5)
...
all_prs_with_APOE %>%
write_tsv("../../data/prs_ad_bellenguez/PRSice/hipsci_polygenic_score_AD_Bellenguez_withAPOE.tsv")
...
pdf("../../data/prs_ad_bellenguez/PRSice/hipsci_full_polygenic_score_AD_Bellenguez_withAPOE_distribution.pdf",
    width = 7, height = 5)
p1 
dev.off()
